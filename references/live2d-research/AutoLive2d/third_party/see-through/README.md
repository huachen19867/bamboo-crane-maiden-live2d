...
> **AutoLive2d vendored fork:** this copy includes Windows setup, a browser WebUI,
> low-VRAM inference paths, execution-device fixes, and optional PSD post-splitting.
> See [LOCAL_CHANGES.md](LOCAL_CHANGES.md). For the canonical upstream project,
> visit [shitagaki-lab/see-through](https://github.com/shitagaki-lab/see-through).
